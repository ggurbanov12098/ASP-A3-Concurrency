...
/**
 * The ImageProcessor class handles the image processing logic, including
 * single-threaded and multi-threaded processing of the image.
 */
public class ImageProcessor {
     ...
     * @param repaintCallback The callback to repaint the image in the GUI.
     */
